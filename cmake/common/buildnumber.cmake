...
if(NOT DEFINED PLUGIN_BUILD_NUMBER)
  if(EXISTS "${_BUILD_NUMBER_CACHE}")
    ...
    if("$ENV{CI}")
      ...
      # Local (non-CI) build with no cache file yet, e.g. a fresh clone.
      # Upstream leaves PLUGIN_BUILD_NUMBER unset here, which then breaks
      # set_target_properties() with "incorrect number of arguments".
      set(PLUGIN_BUILD_NUMBER "1")
    endif()
  endif()
